# copied from: https://github.com/IfcOpenShell/IfcOpenShell/blob/v0.6.0/src/ifcdiff/ifcdiff.py 2020-09-02 SE
...
if __name__ == '__main__':
    ...
    ifc_diff = IfcDiff(file_old, file_new, output, relationships)
    ifc_diff.diff()
    ifc_diff.export()
